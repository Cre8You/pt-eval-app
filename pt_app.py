...
・【実施プログラム】
  計画書更新用カルテ内容に実際に記載されている運動療法、徒手療法、物理療法、動作練習、自主訓練、生活指導などの実施項目だけを、次の形式で必要数だけ記載してください。
  ・〇〇
  ・〇〇
  プログラム名または実施項目だけを短く記載し、目的、効果、対応方針、継続・変更・追加などの説明は付けないでください。同じ内容は重複をまとめ、表記が異なっていても同じプログラムなら簡潔な表現へ統一してください。カルテに記載のない実施内容を現在の評価結果から提案・推測せず、曖昧で実施プログラムと判断できない記載は採用しないでください。該当項目がない場合は「・カルテ記載から確認できる実施プログラムなし」とだけ記載してください。
